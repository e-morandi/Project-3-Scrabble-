...
void Unscrambler::addWord(std::string in) {
	dictionary.insert(std::pair<std::string, int>(in, score(in)));
}

void Unscrambler::checkPermutations(int r, int n, char* arry, std::set<std::string>* valid) {
...
int Unscrambler::score(std::string in) {
	int score = 0;
...
void Unscrambler::unscramble(std::string in) {
